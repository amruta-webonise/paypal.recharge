...
<div id="wrap">
    ...
    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input type="hidden" name="business" value="amruta@weboniselab.com">
        ...
        <input type="hidden" name="return_url" value="http://recharge.webonise.com/">
        <input type="hidden" name="cancel_url" value="http://recharge.webonise.com/" />
        <input type="hidden" name="notify_url" value="http://recharge.webonise.com/" />
